"use client";
import { NavdropFeaturedPosts, Services } from "@/constants";
  ...
  return (
    ...
    >
      ...
      <button className="cursor-pointer flex items-center py-2 transition-all duration-200 text-basecolor hover:border-b-2 hover:border-accent hover:text-accent">
        <span className="font-manrope capitalize">Capabilities</span>
        {isOpen ? (
          <ChevronUp
            size={18}
      ...
      >
        <div className="root-container flex gap-20">
          <div className="flex-2 py-10 space-y-10">
            {/* <h3 className="font-semibold text-xl text-primary">Capabilities</h3> */}
            <div className="grid grid-cols-3 gap-5">
              <div className="space-y-5">
                ...
                <p className="w-[80%] text-sm text-neutral-500">
                  Explore our wide range of capabilities to help you succeed in
          ...
          <div className="flex-1 h-[50vh]">
            {NavdropFeaturedPosts.slice(1, 2).map((item) => (
